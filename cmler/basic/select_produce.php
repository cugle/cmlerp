...
class Pagecustomer extends admin {
	...
	function goDispAppend(){
		...
		$t -> set_var('userid',$this->getUid());		
			...
			$date=$this->dbObj->GetRow('SELECT * FROM '.WEB_ADMIN_TABPOX.'produce WHERE produce_id = '.$updid);
			$t -> set_var($date);			
			$t -> set_var('error',"");
			$t -> set_var('showeditdiv',"");
...
}else
{
		...
		$t -> set_var('brandlist',$this ->selectlist('brand','brand_id','brand_name',$date['brandid']));				
