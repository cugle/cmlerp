...
{ 
 $q="insert into  ".WEB_ADMIN_TABPOX."servicecategory (category_name,memo,agencyid) values ('$data[0]','$data[1]',".$_SESSION["currentorgan"].")"; 
...
fclose($handle); 
		...
		$t -> set_var('backpath','servicecategory.php');
