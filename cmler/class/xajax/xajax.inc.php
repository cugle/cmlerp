...
class xajax
{
	 ...
	 * @return string
	 */
	function getJavascript($sJsURI="",$asynchronism=true, $sJsFile=NULL)
	{	
		$html = $this->getJavascriptConfig($asynchronism);
	 ...
	 * @return string
	 */
	function getJavascriptConfig($asynchronism=true)
	{
		...
		//vanni 2006-10-28 asynchronism
		$html .= "var xajaxAsynchronism=".($asynchronism?'true':'false').";\n";
