...
class Pagecustomer extends admin {
	...
	function goDispAppend(){
		...
		$t -> set_var('membercardlist',$this ->cardlist('marketingcard','marketingcard_id','marketingcard_name','',9));
		...
		$t -> set_var('membercardlist',$this ->cardlist('marketingcard','marketingcard_id','marketingcard_name',$date['inheritedid'],9));	
	...
	function goAppend(){
		...
		if($this -> isAppend){
			$info = '增加';	
			echo "INSERT INTO `".WEB_ADMIN_TABPOX."marketingcard` (`marketingcard_name`, `marketingcard_no`,`marketingcardtype_id`, `coderule`,`totaltimes`, `price`, `timelimit`, `pricepertime`, `assignservice`,`memo`, `agencyid`,`sellcommission`,`beautycommission`,`leadercommission`,inheritedid) VALUES ('" .$_POST["marketingcard_name"]."','".$_POST["marketingcard_no"]."', ".$marketingcardtype_id.",'".$_POST["coderule"]."', '".$_POST["totaltimes"]."', '".$this->intnonull($_POST["price"])."',  '".$this->intnonull($_POST["timelimit"])."','".$this->intnonull($_POST["pricepertime"])."','".$this->intnonull($_POST["assignservice"])."', '".$_POST["memo"]."','".$_SESSION["currentorgan"]."', '".$_POST["sellcommission"]."', '".$_POST["beautycommission"]."', '".$_POST["leadercommission"]."','".$_POST["inheritedid"]."')";
