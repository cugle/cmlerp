...
if (!defined('WEB_ADMIN_DBTYPE')) exit('<script>alert("欢迎使用香蔓店务管理系统！");location.href="'.WEB_ADMIN_HTTPPATH.'/setup/";</script>');
...
//		$this -> debugOn();
	...
	function loginto($style)
	{
		...
		if(($_GET || $_POST) && !isset($_POST['xajax'])){
			//$this->quit();
			//header("'Location:".WEB_ADMIN_HTTPPATH."/pos/pos.php'");
		exit("<script>location.href='".WEB_ADMIN_HTTPPATH."/pos/pos.php';</script>");
		}	
			}
	}
}
