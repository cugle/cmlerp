...
class Pagecustomer extends admin {
	...
	function goAppend(){
		...
		if($this -> isAppend){
			$info = '增加';	
			$this -> dbObj -> Execute("INSERT INTO `".WEB_ADMIN_TABPOX."marketingcard` (`marketingcard_name`, `marketingcard_no`,`marketingcardtype_id`, `coderule`,`totaltimes`, `price`, `timelimit`, `pricepertime`, `assignservice`,`memo`, `agencyid`,`sellcommission`) VALUES ('" .$_POST["marketingcard_name"]."','".$_POST["marketingcard_no"]."', ".$marketingcardtype_id.",'".$_POST["coderule"]."', '".$_POST["totaltimes"]."', '".$this->intnonull($_POST["price"])."',  '".$this->intnonull($_POST["timelimit"])."','".$this->intnonull($_POST["pricepertime"])."','".$this->intnonull($_POST["assignservice"])."', '".$_POST["memo"]."','".$_SESSION["currentorgan"]."', '".$_POST["sellcommission"]."')");
		...
		exit("<script>alert('新增成功');location.href='membercard.php?action=upd&updid=".$id."';</script>");	
			...
			$info = '修改';
			$id = $_POST[MODIFY.'id'];
			$this -> dbObj -> Execute("UPDATE `".WEB_ADMIN_TABPOX."marketingcard` SET `marketingcard_name` = '".$_POST["marketingcard_name"]."',`marketingcard_no` = '".$_POST["marketingcard_no"]."',`marketingcardtype_id`=".$marketingcardtype_id.",`coderule` = '".$_POST["coderule"]."',`totaltimes` = '".$this->intnonull($_POST["totaltimes"])."',`timelimit` ='".$this->intnonull($_POST["timelimit"])."',`price` = '".$this->intnonull($_POST["price"])."',`pricepertime` = '".$this->intnonull($_POST["pricepertime"])."',`assignservice` = '".$this->intnonull($_POST["assignservice"])."',`memo` = '".$_POST["memo"]."',`sellcommission` = '".$_POST["sellcommission"]."' WHERE marketingcard_id =".$id);
