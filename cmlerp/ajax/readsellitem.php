...
$table=$_POST['table']?$_POST['table']:'sellotherdetail';
$column=$_POST['column']?$_POST['column']:'sell_no';
$value=$_POST['value']?$_POST['value']:'XS00100275';
...
if ($inrrs['item_type']=='0'){//购买服务
	...
	$itemtypedata= $this -> dbObj -> GetRow("select *  from ".WEB_ADMIN_TABPOX."marketingcard A INNER JOIN ".WEB_ADMIN_TABPOX."marketingcardtype  B ON  A.marketingcardtype_id=B.marketingcardtype_id where  A.marketingcard_id =".$inrrs['cardid']);
	$itemname=$itemdata[$table_name[$inrrs['item_type']].'_name'];
	...
	}else if($inrrs['item_type']=='4'){//消费卡项
