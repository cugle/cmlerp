...
class Pagecustomer extends admin {
	function disp(){
		...
		if($ftable==''){$condition="s.".$category.'="'.$keywords.'"';}else{$condition="s.".$category.'="'.$keywords.'"';}
			...
			$sql='select * from '.WEB_ADMIN_TABPOX.'stock s INNER JOIN '.WEB_ADMIN_TABPOX."produce f on s.produce_id =f.produce_id  where f.upperlimit <s.number and  s.agencyid =".$_SESSION["currentorgan"] ;
