...
class PageUser extends admin {
	function disp(){
		...
		$todayother=$totaltoday['todayzengsongvalue']+$totaltoday['todaydingjinvalue']+$totaltoday['todaydingjinvalue']+$totaltoday['todayxianjinquanvalue']+$totaltoday['todayyufuvalue'];
        $t -> set_var('todayother',sprintf("%01.2f",$todayother));
		$thismonthother=$totalthismonth['thismonthzengsongvalue']+$totalthismonth['thismonthdingjinvalue']+$totalthismonth['thismonthchuzhikavalue']+$totalthismonth['thismonthxianjinquanvalue']+$totalthismonth['thismonthyufuvalue'];																																													   		$t -> set_var('thismonthother',sprintf("%01.2f",$thismonthother));
 		 $_SESSION["beauty_id"]='';
		 $_SESSION["beauty_name"]=''; 
		 $_SESSION["consultant_id"]='';
		 $_SESSION["consultant_name"]='';
		 $_SESSION['shouquan']='';
		//设置当前机构信息
