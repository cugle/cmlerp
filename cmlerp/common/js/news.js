...
if ($Opera) {
   ...
   $Gecko = false;
   $Safari = false;
}//d欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
if ($IE5) {
         $IE = true;
         $Gecko = false;
         $Safari = false;
}
}//欢迎来到站长特效网，f我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
...
return root;
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效d，本站收集大量高质量js代码，还有许多广告代码下载。
//util
...
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码d，还有许多广告代码下载。
r.thiz=o;
r.fn=fn;
r.rv=rv;
return r;
...
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码f下载。
...
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，d很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
...
return v==null ? d : v;
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载d。
var $gv=$getValue;
var $dom={
parseInt : function(s) {
...
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载h。
...
this.imgMin = "";
this.imgMax = "";
}//欢迎来到站长特效网d，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
//static members
PopUp.STOP = 0;
PopUp.MOVE_DOWN = 1;
PopUp.MOVE_UP = 2;
...
create : function (){
   ...
   sBtn.style.cssText='position:absolute;        z-index:2;                font-size:0px;        line-height:0px;                left:220px;        top:6px;        width:15px;        height:15px;                background-image:url("common/img/min.gif");';
   $addEL(sBtn,"click",$dele(this,"switchMode"),true);
   $addEL(sBtn,"click",$cancelEvent,true);
   var btn = $_t(t,'a',"closeButton");
   btn.style.cssText='position:absolute;        z-index:2;                font-size:0px;        line-height:0px;                left:240px;        top:6px;        width:15px;        height:15px;                background-image:url("common/img/close.gif");';
...
}//欢迎来到站长特效网，e我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
...
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，q很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
return cookieValue;
}
...
}//x欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
...
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长u，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
displayTimeList=[];
for (var i in hours){
   var s = parseInt(i);
   if (isNaN(s)) continue;
...
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量p高质量js代码，还有许多广告代码下载。
function doit(){
