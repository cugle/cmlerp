...
echo iconv('UTF-8','GBK',"/男人/");
echo iconv('UTF-8','GBK',"科目代码")."\t";
echo mb_convert_encoding("科目名称","GB2312","UTF-8")."\t";
echo mb_convert_encoding("借方金额","GB2312","UTF-8")."\t";
echo mb_convert_encoding("借/贷","GB2312","UTF-8")."\t";
echo mb_convert_encoding("余额","GB2312","UTF-8")."\t";
echo mb_convert_encoding("备注","GB2312","UTF-8")."\n";
